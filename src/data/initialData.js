...
export const attendanceNames = [
  ...
  'MOCH AGIL RIDHA',
  'MOCH FADLY RAMDANI',
  'MUHAMAD ANDIKA CHANDRA',
  'MUHAMAD HAIKAL',
  'MUHAMMAD IDHAM FARID',
  'MUHAMMAD PRIHADI',
  'MUHAMMAD RIFKI SAPUTRA',
  'MUHAMMAD RIZAL',
  'NUR HADI RUSLI',
  'PERDINAND ROLAND LOPANG',
  'RANGGA JUNIANTO T',
  'RISKAL WAHYU',
  'RISKY GLORIANUS GALUNTU',
  'RISMAN RUMBIA',
  'ROYAN FIRANSYAH',
  'SABARUDIN',
  'SAHRIN YANI',
